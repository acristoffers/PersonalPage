...
export const LANG_EN_TRANS = {
    ...
    'de': 'German',
    'native': 'Native',
    'about_me': `Mechatronic engineering student with experience in system analysis and control and programming. Loves to work in a cooperative environment towards solving complex problems. Has worked in two scientific initiations toward using an advanced control technique (Model Predictive Control). Loves to learn languages and to help others develop their projects.`,
    'languages': 'Languages',
