...
export const LANG_DE_TRANS = {
    ...
    'about_me': 'Ich bin Mechatronikingenieursstudent an der CEFET-MG in Brasilien. Ich liebe Programmieren und die Idee, große Strukturen mit kleinen Schaltungen zu steuern. Ich interessiere mich auch für Sprachen und Kryptographie.',
    'i_can_speak': 'Ich spreche:',
    ...
    'external_clock': 'Interne Clock',
    'label': 'Label',
    'value': 'Wert',
    'frequency': 'Hz',
    'seconds': 'Sekunden',
    'instructions': 'Befehle',
    'pic8bits': 'PIC 8 bits (MPASM)',
    'pic16bits': 'PIC 16 bits (XC16)',
    'generate': 'generieren'
}
