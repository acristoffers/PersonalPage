...
export const LANG_PT_TRANS = {
    ...
    'de': 'Alemão',
    'native': 'Nativo',
    'about_me': 'Sou um estudante de engenharia mecatrônica no CEFET-MG, Brasil. Amo programar e sou fascinado pela idéia de controlar grandes estruturas com pequenos circuitos. Também sou aficionado com idiomas e criptografia.',
    'i_can_speak': 'Eu falo:',
